                                        ...
                                        shoutouts.map(s => (
                                            <div key={s.id} className="shoutout-item" style={{ padding: '20px', marginBottom: '20px' }}>
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                                                    ...
                                                    <div style={{ background: '#4F46E5', color: 'white', padding: '2px 10px', borderRadius: '20px', fontSize: '0.65rem', fontWeight: 'bold', border: '1px solid #8B5CF6' }}>RECOGNIZING: {s.target_dept ? s.target_dept.toUpperCase() : "TEAM"}</div>
                                                </div>
        ...
        <div className="login-page-bg">
            <div className="wrapper">
                <div className="form-box">
                    ...
                    {message && <p className="msg-text" style={{ color: '#2ecc71', textAlign: 'center', marginBottom: '10px' }}>{message}</p>}
