                        ...
                        {view === "leaderboard" && (
                            <div className="shoutout-item" style={{ padding: '30px' }}>
                                ...
                                {leaderboard.map((user, index) => (
                                    <div key={index} style={{ display: 'flex', justifyContent: 'space-between', padding: '15px', borderBottom: '1px solid #ffffff11' }}>
                                        <span style={{ color: 'white' }}>{index + 1}. {user.name}</span>
                                        <span style={{ color: '#8B5CF6', fontWeight: 'bold' }}>{user.points} Points</span>
                                    </div>
                                ))}
                            </div>
                        )}
