                            ...
                            <div className="bg-black/[0.01] dark:bg-white/[0.02] rounded-[1.8rem] p-8 relative overflow-hidden border border-black/5 dark:border-white/5">
                                ...
                                <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                                    <div className="relative flex-shrink-0">
                                        <div className="absolute inset-0 bg-brand-primary/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity" />
                                        <img
                                            src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${brag.user_id}`}
                                            className="w-20 h-20 rounded-2xl bg-white/5 border border-white/10 relative transition-transform duration-500 hover:rotate-3 shadow-2xl"
                                            alt="User Avatar"
                                        />
                                        <div className="absolute -bottom-2 -right-2 w-7 h-7 bg-brand-primary rounded-xl flex items-center justify-center text-brand-dark text-xs border-2 border-brand-dark shadow-[0_0_10px_rgba(34,211,238,0.5)]">
