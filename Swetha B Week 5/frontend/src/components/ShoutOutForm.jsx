    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 mb-2 font-semibold">Tag Teammates</label>
                    <div className="border rounded p-3 h-48 overflow-y-auto bg-gray-50">
                        <div
                            className="p-2 mb-2 cursor-pointer hover:bg-green-50 text-green-700 font-bold border-b border-green-100 flex items-center justify-between"
                            onClick={() => {
                        ...
                        >
                            <span>{selectedRecipients.length === users.length ? 'Deselect Everyone' : 'Select Everyone'}</span>
                        ...
                        <div className="grid grid-cols-1 gap-1">
                            {users.map(user => (
                                <label key={user.id} className="flex items-center gap-3 p-2 hover:bg-white rounded cursor-pointer transition-colors border border-transparent hover:border-gray-200">
                                    <input
                                        type="checkbox"
