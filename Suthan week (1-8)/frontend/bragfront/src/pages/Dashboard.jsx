...
const Dashboard = () => {
    ...
    try {
      ...
      const shoutFeed = shoutDataList.map(shout => {
        ...
        return {
          ...
          avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=${shout.sender?.name === 'Suthan' ? 'SuthanMale' : shout.sender_id}`,
  ...
  }, [token, navigate, filters, setStats, setDepartments, setColleagues, setLeaderboardData, setCurrentUserId, setCurrentUser, setCurrentUserDepartment, setRecentActivity, setLoading]);
