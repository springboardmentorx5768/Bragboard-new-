    ...
    try {
      ...
      setComments(prev => {
        ...
        if (parentId) {
          ...
          return { ...prev, [shoutoutId]: [...shoutoutComments, newCommentObj] };
        }
      });
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full text-xs font-medium ml-2">
                      {userInfo?.role}
                    </span>
                  </p>
                </div>
                      ...
                      {filteredShoutouts.map((shoutout, index) => {
                        ...
                        return (
                          <motion.div
                            ...
                            whileHover={{ y: -2 }}
                            className="border border-gray-200 rounded-2xl p-6 hover:border-purple-300 hover:shadow-lg transition-all bg-gradient-to-r from-white to-gray-50"
                          >
                            {/* Shoutout Header */}
                              ...
                              <motion.button 
                                ...
                                onClick={() => {
                                  ...
                                  if (comments[shoutout.id]) {
                                    ...
                                    setComments(prev => ({ ...prev, [shoutout.id]: [] }));
                                  }
                                }}
        ...
        <div className="flex justify-around">
          {navItems.map((item) => (
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={() => setActiveTab(item.id)}
              className={`flex flex-col items-center p-2 ${activeTab === item.id ? 'text-purple-600' : 'text-gray-600'}`}
            >
