...
import { FaBars, FaUser, FaPencilAlt, FaChartBar, FaSignOutAlt, FaHome } from "react-icons/fa";
                ...
                <nav className="hidden md:flex items-center gap-6">
                    ...
                    {userRole === 'admin' && (
                        <button
                            ...
                            className="flex items-center gap-2 text-sm px-3 py-2 rounded-lg hover:bg-gray-100 transition text-purple-600 font-bold"
                        >
                            <FaChartBar /> Admin
                        </button>
                    )}
