                    ...
                    {!isEditing ? (
                        ...
                        >
                            <div className="flex justify-center mb-6">
                                <img
                                    src={user.profile_image_url ? `http://localhost:8000${user.profile_image_url}` : "https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png?20150327203541"}
                                    alt="Profile"
